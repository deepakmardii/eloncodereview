  ...
  const testimonials = [
    {
      ...
      quote:
        "I used to have to wait ages for my code to get examined. I've been printing it all up and showing it to Elon since Friday, and it's been so great!",
    },
    {
      ...
      quote:
        "Paper is still relevant today! What a fantastic way to complete code reviews! I adore it.",
    },
    {
      ...
      quote:
        "I am even more productive as a result. I simply press the code, print it, and send it in! And it's much faster now that you can fax!",
    },
    {
      ...
      title: "Founder of meta",
      quote:
        "This is revolutionary. I'm kicking myself for not considering this. Having made ProductHunt the top",
    },
    {
      ...
      title: "Software engineer",
      quote:
        "When requested to print my code, I laughed, but this really does work.",
    },
    {
    ...
    },
    {
      ...
      title: "Software engineer",
      quote:
        "I adore how Elon grades my code and writes the reviews by hand. much like my lecturers in college. from the 1940s.",
    },
    {
      ...
      title: "Product designer",
      quote:
        "Writing code by hand is the best method to learn programming, I tell my pupils. I advise everyone to submit their handwritten code for evaluation to Elon Musk.",
    },
  ];
  return (
